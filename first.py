...
MaskVsNoMask_Filename = "C:/Users/Eng.Donia/Desktop/blabla/Untitled Folder/MaskVsNoMaskFaces.pkl" 
with open(MaskVsNoMask_Filename, 'rb') as file:  
    MaskVsNoMask_model = pickle.load(file)
print(MaskVsNoMask_model) 

CorrectVsIncorrect_Filename = "C:/Users/Eng.Donia/Desktop/blabla/Untitled Folder/CorrectVsIncorrect-BalancedFaces.pkl" 
with open(CorrectVsIncorrect_Filename, 'rb') as file:  
    CorrectVsIncorrect_model = pickle.load(file)  
print(CorrectVsIncorrect_model)

NoMaskVsIncorrectVsCorrectFaces_Filename = "C:/Users/Eng.Donia/Desktop/blabla/Untitled Folder/NoMaskVsIncorrectVsCorrectFaces35k.pkl" 
...
CorrectNoseVsIncorrectNose_Filename = "C:/Users/Eng.Donia/Desktop/blabla/Untitled Folder/CorrectNoseVsIncorrectNose-BalancedFaces.pkl" 
...
# #                         print(int(int(y)+(int(h/2))),int(y+h), int(x),int(x+w))
                                ...
                                cv2.rectangle(imgg,(int(x),int(y)),(int(x+w),int(y+h)),(0,255,0),1) 
...
#         plt.show
    imgg=newsize128(img)
    img1= [cv2.cvtColor(imgg, cv2.COLOR_BGR2GRAY).reshape(-1)]
...
video_capture =cv2.VideoCapture(r"D:/bach/try/arwacorrectMask.mp4")
print(video_capture)
pre1=[]
